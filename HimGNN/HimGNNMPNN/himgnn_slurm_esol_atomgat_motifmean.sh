#!/bin/bash
#SBATCH -J himgnn_esol_atomgat_motifmean                 # Job name
...
python hyperparam_search_v4.py --dataset ESOL --folds 5 --epoch 150 --atom_layer_type gat --motif_layer_type nnconvmean
