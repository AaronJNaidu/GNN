#!/bin/bash
#SBATCH -J himgnn_clintox_atomgat_motifgcn                 # Job name
...
python hyperparam_search_v4.py --dataset ClinTox --folds 5 --epoch 150 --atom_layer_type gat --motif_layer_type gcn
