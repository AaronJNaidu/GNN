#!/bin/bash
#SBATCH -J himgnn_esol_full_atomgin_motifgin                 # Job name
...
python hyperparam_search_v4.py --dataset ESOL --folds 5 --epoch 150 --atom_layer_type gin --motif_layer_type gin
