...
class HGNN(nn.Module):
    def __init__(self,
        ...
        self.motif_mp_layer=DGL_MPNNLayer(args.hid_dim,nn.Linear(args.ss_edge_in_dim,args.hid_dim*args.hid_dim),args.resdual, layer_type = args.motif_layer_type)
        self.atom_mp_layer=DGL_MPNNLayer(args.hid_dim,nn.Linear(args.bond_in_dim,args.hid_dim*args.hid_dim),args.resdual, layer_type = args.atom_layer_type)
    ...
    def forward(self, g, af, bf, fnf, fef,mf,labels=None):
        with g.local_scope():
