...
def load_data(dataset, batch_size, cpus_per_gpu, fold, name):
    ...
    if split == 'balan_scaffold':
        ...
        while cont:
            ...
            if task == 'clas':
                ...
                cont = False
    '''
    trainset, validset, testset = predetermined_split(data, fold, name) 
...
def predetermined_split(dataset, fold, name):
    ...
    for i, s in enumerate(dataset.smi):
